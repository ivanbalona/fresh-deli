...
class __TwigTemplate_c2aaedc889151930eadeb6972daaf5be0e3527fe14bb52384982b6aaeccbd3a8 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/classy/templates/content-edit/filter-tips.html.twig", "C:\\xampp\\htdocs\\cs\\core\\themes\\classy\\templates\\content-edit\\filter-tips.html.twig");
    }
